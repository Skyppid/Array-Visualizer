...
#End Region
    ...
    Private Sub buttonStandard_Click(sender As Object, e As EventArgs) Handles buttonStandard.Click
        ...
        Dim arr2 As TestType(,) = Enumerator.Generate (Of TestType)(15, Function(X1) GetNewType(X1)).Shuffle().ToArray(5,
                                                                                                                       3)
    ...
    Private Shared Function GetJaggedArray2() As Integer()()
        ...
        Dim arr = New Integer()() _
                {New Integer() {1, 2, 3}, New Integer() {1, 2, 3, 4, 5}, New Integer() {1}, New Integer() {1, 2, 3},
                 New Integer() {1, 2}}
        Return arr
    End Function
        ...
        Dim arr()()() As Integer =
                ...
                {New Integer() {1, 2, 3}, New Integer() {1, 2, 3, 4, 5}, New Integer() {1}, New Integer() {1, 2, 3},
                 New Integer() {1, 2}},
                    New Integer()() _
                {New Integer() {1, 2, 3}, New Integer() {1, 2, 3, 4, 5}, New Integer() {1}, New Integer() {1, 2, 3}},
                    New Integer()() {New Integer() {1, 2, 3}, New Integer() {1, 2, 3, 4, 5}, New Integer() {1}},
    ...
    Private Sub buttonFsNatrix_Click(sender As Object, e As EventArgs) Handles buttonFsNatrix.Click
        ...
        Dim v2 = Microsoft.FSharp.Math.MatrixTopLevelOperators.vector(New Double() _
                                                                         {1.11, 2.22, 3.33, 5.55, 4.44, 3.33, 1.11})
